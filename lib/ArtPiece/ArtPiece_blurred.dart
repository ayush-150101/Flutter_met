...
class ArtPiece_blurred extends StatefulWidget {

  int objectID;
  ArtPiece_blurred({Key key, @required this.objectID})
      : super(key: key);

  @override
  _ArtPiece_blurredState createState() => _ArtPiece_blurredState();
}

class _ArtPiece_blurredState extends State<ArtPiece_blurred> {
